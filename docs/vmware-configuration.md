...
*Figure 1: VMware Workstation Pro library showing virtual machine configuration.*
...
![Network Interface Details](screenshots/06-network-information.png)
*Figure 2: Network interface configuration and IP address verification (`ip a`).*
